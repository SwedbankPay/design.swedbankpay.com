...
const AutoLayoutColumns = () => (
    <>
        ...
        <p>Create equal-width columns that span multiple rows by inserting a <CodeTags type="secondary" code=".w-100" /> where you want the columns to break to a new line. Make the breaks responsive by mixing the <CodeTags type="secondary" code=".w-100" /> with some <Link to="/docs/utilities/display">responsive display utilities</Link>.</p>
        <ComponentPreview language="html" showCasePanel codeFigure removeOuterTag>
            <div className="showcase-grid">
                <div className="container">
                    <div className="row">
...
const Reordering = () => (
    <>
        ...
        <p>You can offset grid columns in two ways: our responsive <CodeTags type="secondary" code=".offset-" /> grid classes and our <Link to="/docs/utilities/display">margin utilities</Link>. Grid classes are sized to match columns while margins are more useful for quick layouts where the width of the offset is variable.</p>
