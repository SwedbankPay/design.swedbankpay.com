...
const Notation = () => (
    <>
        ...
        <p>
            Display utility classes that apply to all <Link to="/docs/core/breakpoints">breakpoints</Link>, from <CodeTags type="secondary" code="xs" /> to <CodeTags type="secondary" code="xxl" />, have no breakpoint abbreviation in them. This is because those classes are applied from <CodeTags type="secondary" code="min-width: 0;" /> and up, and thus are not bound by a media query. The remaining breakpoints, however, do include a breakpoint abbreviation.
        </p>
