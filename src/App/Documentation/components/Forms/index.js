...
const RangeSlider = () => (
    <>
        ...
        <p>Currently there are three different supported colors for the slider:  <code className="token property">rangeslider-brand</code>, <code className="token property">rangeslider-default</code> and <code className="token property">rangeslider-neutral</code>. If no color is given, "brand" is default.</p>
        
        <p>The Rangeslider currently supports two positions: <code className="token property">value-label-position-right</code> and <code className="token property">value-label-position-top</code>. If no position is given, "right" is default.</p>
        <ComponentPreview language="html" showCasePanel={true} codeFigure={true}>
