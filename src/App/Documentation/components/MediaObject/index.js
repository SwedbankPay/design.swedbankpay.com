...
const Overview = () => (
    <>
        ...
        <ComponentPreview language="html" showCasePanel={true} codeFigure={true}>
            <MediaObjectComponent imgUrl="http://via.placeholder.com/48x48" heading="Bob Corlsan" text="bob.corlsan@payex.com" />
...
const Sizes = () => (
    <>
        ...
        <ComponentPreview language="html" showCasePanel={true} codeFigure={true}>
            <MediaObjectComponent size="sm" imgUrl="http://via.placeholder.com/40x40" heading="Bob Corlsan" text="bob.corlsan@payex.com" />
        ...
        <ComponentPreview language="html" showCasePanel={true} codeFigure={true}>
            <MediaObjectComponent size="lg" imgUrl="http://via.placeholder.com/56x56" heading="Bob Corlsan" text="bob.corlsan@payex.com" />
...
const MediaAlignment = () => (
    <>
        ...
        <ComponentPreview language="html" showCasePanel={true} codeFigure={true}>
            <MediaObjectComponent mediaRight imgUrl="http://via.placeholder.com/48x48" heading="Bob Corlsan" text="bob.corlsan@payex.com" />
