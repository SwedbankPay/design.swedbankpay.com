	...
	elements: [
		{
			...
			component: (
				<LogotypeComponent
					src={`${basename}img/logo/swedbankpay-logo-v.svg`}
								...
								description: (
									<Alert
										...
										text={
											<p>
												<b>Important. </b>
												This is the smallest version of the logotype that can be
												used! Never alter this logotype to fit smaller spaces.
											</p>
										}
									/>
								),
		...
		},
		{
			...
			component: (
				<LogotypeComponent
					src={`${basename}img/logo/swedbankpay-logo-h.svg`}
			...
			description: (
				<>
					The horizontal logo is only used if the vertical primary logotype can
					not be used. Reasons for using the horizontal logo might be:
					<ul className="list list-bullet mt-3">
						<li>
							The primary logo font is too similar in size to other fonts close
							by
						</li>
						<li>
							The primary logo is too small/wrong format compared to other
							logotypes in the same context
						</li>
					</ul>
				</>
			),
	...
	elements: [
		{
			...
			component: (
				<LogotypeComponent
					src={`${basename}img/logo/swedbankpay-logo-v-neg.svg`}
					alt="Swedbank Pay vertical logo"
					type="vertical"
				/>
			),
			...
			description: (
				<p>
					The vertical logo should always be considered before the horizontal
					logo.
				</p>
			),
		},
		{
			...
			component: (
				<LogotypeComponent
					src={`${basename}img/logo/swedbankpay-logo-h-neg.svg`}
					alt="Swedbank Pay horizontal logo"
					type="horizontal"
				/>
			),
			...
			description: (
				<p>
					The horizontal logo is only used if the vertical logotype can not be
					used.
				</p>
			),
		},
	...
	elements: [
		{
			...
			component: (
				<LogotypeComponent
					src={`${basename}img/logo/payex-logo.svg`}
					alt="PayEx logo"
					type="horizontal"
				/>
			),
		...
		},
		{
			...
			component: (
				<LogotypeComponent
					src={`${basename}img/logo/payex-logo-neg.svg`}
					alt="PayEx logo"
					type="horizontal"
				/>
			),
			...
			description: (
				<p>
					Should only be used on PayEx primary color (green) and on dark
					backgrounds. The green logo is the primary logo and should always be
					considered before moving on to another version.
				</p>
			),
		},
	],
