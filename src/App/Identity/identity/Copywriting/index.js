...
const Terminology = () => (
    <section>
        ...
        <h3>Microcopy</h3>
        <p>
            Microcopy is all the written content you find on buttons, links, menu items, in error messages and so on. Microcopy helps the user interact with the product.
            It lets the user know what to do at a certain point, explains errors, builds confidence in the user when taking an action,
        ...
        <h3>UX copy</h3>
        <p>
            UX copy consists of all interface copy in a digital product, so basically all the text you see, including headings and paragraphs with information.
            Microcopy is part of UX copy, but UX copy also includes longer content relevant to the usage of a digital product.
        </p>

        <h3>Content</h3>
        <p>
            Content is what you call the longer format texts, for instance the detailed presentation of a product or service, the “About us” section and blog posts.
        </p>
        <p>
...
const Tonality = () => (
    <section>
        ...
        <p>
            We express ourselves as simply and uncomplicated as possible to make our message easy to understand. It is important that our communication feels trustworthy,
            welcoming and friendly. We provide solutions. What we write should always be guiding our customers forward.
        </p>
        ...
        <ul className="list list-bullet">
            <li><span className="font-weight-bold">using a conversational language</span> – avoiding jargon, complex words and expressions. </li>
            <li><span className="font-weight-bold">guiding the customer</span> – with specific CTA’s so they know what to do next.</li>
            <li><span className="font-weight-bold">showing warmth</span> – we speak with a human voice, with the person and not to them</li>
        </ul>
        <p>
            For more on UX writing, see Glossary and other links section.
        </p>

        <h3>We and you</h3>
        <p>
            We want customers to feel that our communication is written by human beings. To accentuate the human touch, we use “we”.
            This will make the message more personal and show our commitment. We address customers with “you”. This includes headlines,
            for example: Your contact information, your invoices etc.
        </p>

        <h3>Simple and guiding</h3>
        <p>
            Merchants and consumers want to buy and sell – they do not want to read long and complicated texts.
            Always write with the intended reader in mind. Brief, simple sentences ensure readability and understanding.
            We avoid difficult words, abbreviations, buzzwords, clichés and exaggerations. What we write should guide and help the reader to take the next step.
        </p>

        <h3>Positive voice</h3>
        <p>
            We offer solutions for merchants and consumers. Whatever we do and say must feel like a way forward. A positive voice will add energy and give us a forward-leaning expression. We are responsible, but with a twinkle in our eyes.
        </p>

        <h3>Tonality examples</h3>
        <p>
            A consistent voice, simple language and a positive tone will ensure more personal communication.
        </p>
        ...
        <div className="d-flex flex-column align-items-center">
            <table className="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Merchants can offer customers longer payment deadline on invoices.</td>
        ...
        <p>
            Words on a screen are no substitute for a real conversation, but the right choice of words will add personality and warmth.
            Even though our interface writing should be concise and clear we want to ensure a more personal communication and that we are perceived as easy to deal with.
        </p>
        <div className="d-flex flex-column align-items-center">
            <table className="table">
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Sorry, we can not find an account with this username. Do you need assistance?</td>
                    </tr>
                    <tr>
                        <td>Please launch the BankID security app on your mobile device. Closing this page will cancel the login.</td>
...
const GlossaryLinks = () => (
    <section>
        ...
        <p>
            ...
            On their respective platforms you can find more detailed information about UX and Swedbank’s brand identity in general,
            but also about writing for these areas in particular.
        </p>
        <div className="d-flex flex-column mb-3">
            <a href="https://ux-design.swedbank.com/content/sites/swedbank/ux-design/en/home/start.html" rel="noopener noreferrer" target="_blank" className="icon-link">
                <i className="material-icons" aria-hidden="true">open_in_new</i>
                <span className="ml-2">UX writing at Swedbank</span>
            </a>
            <a href="https://ux-design.swedbank.com/content/sites/swedbank/ux-design/en/home/start/ux-writing.html" rel="noopener noreferrer" target="_blank" className="icon-link">
                <i className="material-icons" aria-hidden="true">open_in_new</i>
