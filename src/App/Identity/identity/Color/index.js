...
const ColorContrast = () => (
    <section>
        ...
        <div className="d-flex flex-row justify-content-around color-contrast-section">
            ...
            <span className="d-flex"><i className="material-icons cancel mr-1" aria-hidden="true">warning</i><b>OK for graphics or large text (&ge; 3:1)</b></span>
            <span className="d-flex"><i className="material-icons alert-warning mr-1" aria-hidden="true">cancel</i><b>Fail</b></span>
        </div>
    </section>
);
...
export { Lead, ColorContrast, BrandColors, TextColors, BackgroundColors, BrownScaleColors, SystemColors, MainColors };
