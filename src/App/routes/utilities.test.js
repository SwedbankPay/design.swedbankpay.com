...
describe("Routes: docs", () => {
    ...
    it("is defined", () => {
        expect(utilitiesRoutes).toBeDefined();
    });

    it("is an array", () => {
        expect(utilitiesRoutes).toBeInstanceOf(Array);
    });

    it("all top routes has a title, path redirect and routes of type array", () => {
        utilitiesRoutes.forEach(({ title, path, redirect, routes }) => {
    ...
    it("all top path and redirect routes is formatted correctly", () => {
        utilitiesRoutes.forEach(({ path, redirect }) => {
