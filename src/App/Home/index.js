    ...
    return (
        <div className="documentation container pt-3 pb-3">
            ...
            <div className="row justify-content-center mt-5">
                <div className="col-12 col-md-5 pt-3 pt-md-0 d-flex align-self-center">
                    <div className="doc-card card card-secondary">
                        <header className="card-header">
                            <h2>Examples</h2>
                        </header>
                        <div className="card-body text-center d-flex flex-column">
                            <div className="doc-circle mb-4">
                                <i className="material-icons material-icons-large text-white">view_quilt</i>
                            </div>
                            <p>Example usages of parts available on the Design Guide.</p>
                            <Link className="btn btn-guiding btn-outline btn-block mt-auto" to="/examples/getting-started/introduction">Examples</Link>
                        </div>
                    </div>
                </div>
            </div>
