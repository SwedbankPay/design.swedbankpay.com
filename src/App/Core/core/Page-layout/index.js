...
const FullWidth = () => (
    <>
        ...
        <p>
            ...
            For a full width layout use <CodeTags type="secondary" code=".border-left" /> to clearly seperate the sidebar and the main content. See <Link to="/utilities/borders">borders</Link> docs for more information.
        </p>
