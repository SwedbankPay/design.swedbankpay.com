...
const Intro = () => (
    <section>
        ...
        <p>Our grid system is a modified version of the Bootstrap grid-system, learn more about how it works in the <a href="#" className="icon-link m-0"><span className="mr-2">Bootstrap documentation.</span><i className="material-icons" aria-hidden="true">open_in_new</i></a>. If you are curious about how the grid is being used in design, head over to the <a href="#" className="icon-link m-0"><span className="mr-2">Grid file in Figma.</span><i className="material-icons" aria-hidden="true">open_in_new</i></a></p>
    </section>
);
