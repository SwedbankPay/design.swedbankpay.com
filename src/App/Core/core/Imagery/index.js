...
const ImageLibrary = () => (
    <section>
        ...
        <a href="https://www.funka.com/design-for-alla/lagar-och-regler/" className="icon-link d-block"><i className="material-icons mr-2" aria-hidden="true">open_in_new</i><span className="mr-2">Visit the Swedbank Pay Image Library</span></a>
        <img src={`${basename}img/documentation/imagery/image-group.svg`} alt="Illustration of impairments"/>
...
const FocalPoints = () => (
    <section>
        ...
        <div className="img-container pb-4">
            <img src={`${basename}img/documentation/imagery/women-on-bus.svg`} alt="Illustration of impairments"/>
            <span><span className="font-weight-bold">Figure 1.</span> A woman with headphones sitting on a bus looking out through the window to the right.</span>
        </div>
        ...
        <img src={`${basename}img/documentation/imagery/donts-1.svg`} alt="Illustration of impairments"/>
    </section>
);
...
const UsingImagery = () => (
    <section>
        ...
        <img src={`${basename}img/documentation/imagery/donts-2.svg`} alt="Illustration of impairments"/>
    </section>
);
