...
const FocalPoints = () => (
    <section>
        ...
        <div className="img-container pb-4">
            <img src={`${basename}img/documentation/imagery/women-on-bus.svg`} alt="A woman with headphones sitting on a bus looking out through the window to the right"/>
        ...
        <img src={`${basename}img/documentation/imagery/donts-1.svg`} alt="Image describing what not to do"/>
    </section>
);
