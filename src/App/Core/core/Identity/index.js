...
const OurBrand = () => (
    <section>
        ...
        <div className="brand-quote">
            <span className="big-quotation-mark">“</span>
            <p className="mb-3">We are warm and welcoming, we guide, we involve users, we ensure access for all, we are consistent and we design for trust.</p>
        </div>
...
const MenuOverview = () => (
    <section>
        ...
        <div className="overview-grid">
            <Link to="/core/accessibility" className="cards cards-wide m-0">
            ...
            <Link to="/core/color" className="cards cards-wide m-0">
                <div className="cards-content m-0">
            ...
            <Link to="/core/copywriting" className="cards cards-wide m-0">
                <div className="cards-content m-0">
            ...
            <Link to="/core/imagery" className="cards cards-wide m-0">
                <div className="cards-content m-0">
            ...
            <Link to="/core/iconography" className="cards cards-wide m-0">
                <div className="cards-content m-0">
            ...
            <Link to="/core/grid" className="cards cards-wide m-0">
                <div className="cards-content m-0">
            ...
            <Link to="/core/logotype" className="cards cards-wide m-0">
                <div className="cards-content m-0">
            ...
            <Link to="/core/spacing" className="cards cards-wide m-0">
                <div className="cards-content m-0">
            ...
            <Link to="/core/typography" className="cards cards-wide m-0">
                <div className="cards-content m-0">
