...
const UtilityPresenter = ({ util, css, example, breakpointVersion }) => (
	<div className="d-flex justify-content-between mb-2">
		...
		{breakpointVersion ? (
			<CodeTagComponent type="tertiary" code={example} />
		) : (
	...
	},
	{
		...
		content: (
			<>
				...
				<div className="col-12 text-default bg-secondary p-1">
					.bg-secondary
				</div>
				<div className="col-12 text-default bg-tertiary p-1">.bg-tertiary</div>
				<div className="col-12 text-default bg-quaternary p-1">
					.bg-quaternary
				</div>
