...
const Overview = () => (
    <>
        ...
        <p>Use class <CodeTags type="secondary" code=".badge" /> along with <CodeTags type="secondary" code=".badge-{color}" /> to display the badge of your choosing. Badges are often used with numbers. Use <CodeTags type="secondary" code=".badge-number" /> when a badge suited for use with numbers is desired.</p>
        ...
        <ul className="list list-bullet">
            ...
            <li>If you want removable badges considering using the tag component instead.</li>
