    ...
    <>
        {number ?
            ...
            <div className="badge-showcase">
                ...
                <p> <span className="badge badge-gray-light">Document</span></p>
                <p> <span className="badge badge-brown">Document</span></p>
                <p> <span className="badge badge-brown-soft">Document</span></p>
                <p> <span className="badge badge-pink">Document</span></p>
                <p> <span className="badge badge-red-light">Document</span></p>
            </div>
        }
    </>
);
