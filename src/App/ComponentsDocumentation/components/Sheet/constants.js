        ...
        {footer ?
            <div>
                ...
                <Sheet id="demo-sheet-footer" footer={true} title="Title">
                    ...
                    <InputGroup type="text" label="Name" id="sheet-name-showcase-example" />
                    <InputGroup type="tel" label="Phone number label" id="sheet-phone-showcase-example" />
                    <InputGroup type="email" label="Email" id="sheet-email-showcase-example" />
                </Sheet>
            </div>
            :
            <>
