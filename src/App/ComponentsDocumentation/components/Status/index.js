...
const Overview = () => (
	<>
		...
		<p>
			Be aware of what color you use when deciding what message you want to
			convey. A completion status should not use a warning or danger status,
			that is why <CodeTags type="secondary" code=".status-success" /> exists.{" "}
			<b>NOTE:</b> Be careful not to rely solely on the color of the status icon
			to convey your message.
		</p>
		<ComponentPreview
			language="html"
			showCasePanel
			showCasePanelAdvanced={showcaseStatusComponent}
		></ComponentPreview>
	</>
);
...
const ExtendedUsage = () => (
	<>
		...
		<p>The status component inherits the size of its direct parent.</p>
...
const Status = () => (
	<DocContainer>
		<p className="lead">
			The status component is a good way to convey to the user the state of
			something.
		</p>
		<Overview />
		<ExampleUse />
