	...
	elements: [
		{
			...
			description:
				"The default setup of the checkbox group has a label on top which describes the checkbox group and each individual checkbox is then followed by a label which clearly describes the option and what checking the box represents.",
		},
	],
};
