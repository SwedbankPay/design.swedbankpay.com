...
const Overview = () => (
    <section id="pagination-overview">
        ...
        <p>While the pagination component supports infinite amount of pages, it is difficult for the user to find what they are looking for if the number of pages are high. To mitigate this ux problem, consider supplementing the pagination with a search as well as more advanced filter functionality.</p>
