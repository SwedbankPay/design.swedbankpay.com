	...
	elements: [
		{
			...
			description: (
				<p>
					The accordion component can be either collapsed or expanded.
					Accordions are by default in the collapsed state with the body content
					hidden. If a group of accordions are wrapped in a{" "}
					<CodeTags type="primary" code=".accordion-group" />, only one will be
					open at a time.
				</p>
			),
		},
