	...
	<Alert
		...
		text={
			<p>
				...
				<br />
				Remember to include at least two alternate ways for interpreting the
				data. Either by showing the chart data in a table or by providing a text
				summary in the <CodeTags type="primary" code="aria-label" />.
			</p>
		}
	/>
);
...
const LineChart = () => (
	<>
		...
		<p>
			...
			to show trend data, or the comparison of two data sets.
		</p>
		<p>
			See{" "}
			<a
			...
			for more information on line charts.
		</p>
...
const BarChart = () => (
	<>
		...
		<p>
			...
			for more information on bar charts.
		</p>
		<ComponentPreview language="html" showCasePanel codeFigure>
			<Chart
				id="simple-bar-chart"
						...
						datasets: [
							{
								...
								data: [
									6.75, 9.25, 11.75, 14.5, 17, 18.75, 18, 15.5, 13, 10.25, 7.5,
									6,
								],
							},
						],
					...
					data: {
						...
						datasets: [
							...
							},
							{
								...
								data: [
									4.9, 3.6, 4.7, 4.1, 5.3, 6.5, 8.1, 8.9, 9, 8.4, 7.3, 5.5,
								],
							},
							{
								label: "Average temperature (in celcius)",
								data: [
									-1.7, -4.1, -2.3, 6.5, 16.1, 17.9, 22.2, 16.3, 12.5, 7.4, 1.6,
									-1.5,
								],
							},
						],
...
const DoughnutAndPieCharts = () => (
	<>
		...
		<p>
			...
			for more information on doughnut and pie charts.
		</p>
		<ComponentPreview language="html" showCasePanel codeFigure>
			<Chart
				id="simple-pie-chart"
		...
		<h2>Doughnut</h2>
		<p className="lead">
			Did anyone say <code className="token string">doughnut</code>?
		</p>
		<ComponentPreview language="html" showCasePanel codeFigure>
			<Chart
				id="doughnut-chart"
...
const MixingTypes = () => (
	<>
		...
		<p className="lead">
			With Chart.js, it is possible to create{" "}
			<a
				href="https://www.chartjs.org/docs/latest/charts/mixed.html"
				target="_blank"
				rel="noopener noreferrer"
			>
				mixed charts
			</a>{" "}
			that are a combination of two or more different chart types. A common
			example is a bar chart that also includes a line dataset.
		</p>
		<ComponentPreview language="html" showCasePanel codeFigure>
			<Chart
				id="mixed-chart"
...
const CustomColors = () => (
	<>
		...
		<p>
			Except for the three first colors, the rest of the colors are
			customizable. Call <CodeTags type="secondary" code="dg.chart" /> with a
			last optional argument consisting of a list of RGB color codes.
		</p>
		<ComponentPreview language="html" showCasePanel codeFigure>
			<Chart
				id="custom-color-pie"
