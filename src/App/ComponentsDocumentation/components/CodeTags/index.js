...
const CodeTags = () => (
    <DocContainer docToc >
        <p className="lead">Tags are used to label, categorize and organize items using keywords that describe them. Code tags can be used to display code in text.</p>
        <Overview />
        <ContentGuidelines/>
    </DocContainer>
);
