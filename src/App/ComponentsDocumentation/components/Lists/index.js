...
const BasicList = () => (
	<>
		...
		<p>
			Add <CodeTags type="secondary" code=".list" /> to a list to display the
			basic list. Our lists do not use bullet points.
		</p>
		...
		<h3>Nested list</h3>
		<p>
			Use nesting with lists to signify that some items are children of another
			item.
		</p>
		<ComponentPreview language="html" showCasePanel codeFigure>
			<ul className="list">
...
const InlineList = () => (
	<>
		...
		<p>
			Use <CodeTags type="secondary" code=".list-inline" /> on a list to make
			all items appear on the same line.
		</p>
		<ComponentPreview language="html" showCasePanel codeFigure>
...
const BulletList = () => (
	<>
		...
		<p>
			Add <CodeTags type="secondary" code=".list-bullet" /> on a list to make it
			a bullet list.
		</p>
		<ComponentPreview language="html" showCasePanel codeFigure>
...
const DescriptionList = () => (
	<>
		...
		<p>
			The description list lets you provide each item with a more specific
			description of each item. Add{" "}
			<CodeTags type="secondary" code=".description-list" /> to your dl.
		</p>
		<ComponentPreview language="html" showCasePanel codeFigure>
...
const SettingsList = () => (
	<>
		...
		<p>
			Use <CodeTags type="secondary" code=".settings-list" /> to visualize
			different settings in your web application.
		</p>
		<ComponentPreview language="html" showCasePanel codeFigure>
...
const ItemList = () => (
	<>
		...
		<p>
			<CodeTags type="secondary" code=".item-list" />s is a good way to offer
			more extensive information about each item. Each item has their own box
			which seperates the items more clearly than our other options.
		</p>
		<ComponentPreview language="html" showCasePanel codeFigure>
...
const HoverItemList = () => (
	<>
		...
		<p>
			Include <CodeTags type="secondary" code=".item-list-hover" /> to give your
			items a hover effect. You can use this on any variation of{" "}
			<CodeTags type="secondary" code=".item-list" />.
		</p>
		<ComponentPreview language="html" showCasePanel codeFigure>
...
const StripedItemList = () => (
	<>
		...
		<p>
			If you want more seperation between each item you can use{" "}
			<CodeTags type="secondary" code=".item-list-striped" />.
		</p>
		<ComponentPreview language="html" showCasePanel codeFigure>
			<ul className="item-list item-list-striped">
				...
				<li>
					...
					{"\n"}
					<a href={`https://developer.${process.env.brand}.com`}>
						developer.{process.env.brand}.com
					</a>
					{"\n"}
				</li>
				<li>
