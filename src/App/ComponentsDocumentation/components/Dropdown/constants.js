	...
	elements: [
		{
			...
			description: (
				<p>
					The select options are used when you want the user to choose one
					element. It can be implemented as a customized select or a radio
					button list. If you are using the select variant in a form, consider
					using the <Link to="/components/select">Select component</Link>{" "}
					instead.
				</p>
			),
		},
		{
			...
			component: (
				<DropdownComponent
					label="Actions"
					content={tabsContent.actionsListItems}
				/>
			),
			options: dropdownSidebarOptions(),
			title: "Action list",
			description:
				"The popover is a container for various content. It usually contains a list of actions or options but it can also contain other type of controls or content like input fields and buttons. Popovers are usually triggered by a button component but they can also be triggerd by other elements. You can set the preffered position of the Popover in relation to it’s trigger, by default the position will be bottom left. It will make sure it is positioned within the viewport, this means that sometimes the Popover flips or move slightly to the left or right.",
		},
		{
			tab: "Checkbox",
			component: (
				<DropdownComponent
					...
					content={tabsContent.checkboxes}
					largePadding={true}
				/>
			),
			options: dropdownSidebarOptions(),
			title: "Checkbox",
			description:
				"Use a checkbox list if you have a small to a medium number of options, and want the user to select one or more of the options. When using a checkbox list drop-down menu, could be combined with the tag component to indicate the chosen options from the drop-down menu.",
		},
		{
			tab: "Form group",
			component: (
			...
			title: "Form group",
			description:
				"The dropdown menu can also have form component inside it. Here you can use different type of components ex. date pickers, rannge sliders etc.",
		},
	],
};
		...
		example2: (
			<>
				...
				<a
					...
					key="item-dodont-example2-action-1"
				>
					Edit
				</a>
				<a
					href="#"
					onClick={(e) => e.preventDefault()}
					key="item-dodont-example2-action-2"
				>
					Delete
				</a>
			</>
		...
		example1: (
			<>
				<a
					href="#"
					onClick={(e) => e.preventDefault()}
					key="item-dodont-example1-action-1"
				>
					Rename
				</a>
				<a
					href="#"
					onClick={(e) => e.preventDefault()}
					key="item-dodont-example1-action-2"
				>
					Edit HTML
				</a>
			</>
		...
		example3: (
			<>
				<a
					href="#"
					onClick={(e) => e.preventDefault()}
					key="item-dodont-example3-action-1"
				>
					Add item
				</a>
				<a
					href="#"
					onClick={(e) => e.preventDefault()}
					key="item-dodont-example3-action-2"
				>
					Edit list
				</a>
			</>
		...
		example4: (
			<>
				<a
					href="#"
					onClick={(e) => e.preventDefault()}
					key="item-dodont-example4-action-1"
				>
					Add an item
				</a>
				<a
					href="#"
					onClick={(e) => e.preventDefault()}
					key="item-dodont-example4-action-2"
				>
					Edit the list
				</a>
			</>
			...
			},
			{
				...
				content: (
					<DropdownComponent
						...
						label="Actions"
						content={dropdownExamples.howToUseExamples.example2}
						isIconButton={false}
						largePadding={true}
					/>
				),
		...
		examples: [
			{
				...
				content: (
					<DropdownComponent
						...
						content={dropdownExamples.contentGuidelinesExamples.example1}
						isIconButton={true}
					/>
				),
			},
			{
				...
				content: (
					<DropdownComponent
						...
						content={dropdownExamples.contentGuidelinesExamples.example2}
						isIconButton={true}
					/>
				),
				rowDescription:
			...
			},
			{
				...
				content: (
					<DropdownComponent
						...
						content={dropdownExamples.contentGuidelinesExamples.example3}
						isIconButton={true}
					/>
				),
			},
			{
				...
				content: (
					<DropdownComponent
						...
						content={dropdownExamples.contentGuidelinesExamples.example4}
						isIconButton={true}
					/>
				),
				rowDescription:
