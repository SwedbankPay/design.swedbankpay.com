...
export const howToUse = [
    {
        ...
        error: <>
            <p><b>Do you have any credit cards</b></p>
            <Togglebox id="ex2" label="Yes"/>
        </>,
        text: <p>Instead of using a togglebox for answering yes/no questions it is better to use <Link to="/components/radio-button">radio buttons</Link>.</p>
    },
    {
        success: <>
        ...
        text: <p>Instead of using a togglebox for actions that won’t happen until a submit button is pressed it is better to use a <Link to="/components/checkbox">checkbox</Link>.</p>
    },
    {
        success: <>
        ...
        text: <p>Do use toggleboxes for on/off preferences of features or behaviour, don’t use checkboxes.</p>
    }
];
