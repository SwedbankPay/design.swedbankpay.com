	...
	<section>
		<section>
			...
			<section>
				<h3>JavaScript</h3>
				<p>
					Some of the Design System components require javascript (not all of
				...
				<div className="alert alert-informative">
					...
					<p>
						<b>Recommended way:</b> Importing component per component means you
						do not end up importing the javascript for components you are not
						using. This way your js served to the user is smaller, thus
						enhancing a faster experience for the users.
					</p>
				</div>
				...
				<div className="alert alert-informative">
					...
					<p>
						<b>Standards:</b> Our JS uses modern features such as
						optional-chaining. If you're experiencing issues you might want to
						look at our browser support. In the case our browser support is not
						enough for your project you might want to use polyfills and/or Babel
						transpiling to fix it.<br></br>Also, some build tools such as
						Webpack 4 do not support some of those features. You can then use
						Babel to transpile the code from the Design System package.
					</p>
				</div>
			</section>
			<section>
				...
				<p>
					...
					<CodeTags type="secondary" code="js" /> file if your bundler supports
					it, <em>or</em> point to the file directly from your bundler.
				</p>
				<p>
					We do not have a recommended way so far. This being said, importing
					from the style file might be easier and can leverage the CSS layers ({" "}
				...
				<div className="alert alert-informative">
					...
					<p>
						<b>Import only once:</b> Either import from the style file{" "}
						<em>OR</em> from the build tool. If you import through both you will
						end up loading twice the styles on the client, which has a negative
						impact on the web-performance.
					</p>
				</div>
			</section>
			<section>
				...
				<p>
					Import <CodeTags type="primary" code={`variables-${brand}.less`} />{" "}
				...
				<div className="alert alert-informative">
					...
					<p>
						...
						import them individually then you might want to check about
						tree-shaking (purging dead code).
					</p>
				</div>
			</section>
			<section>
				...
				<p>
					In this video we show a real life example on how to use the design
					guide through NPM.
				</p>
				<DGLightVideo />
			</section>
		...
		<section>
			...
			<p>
				To quickly add the {brandTitle} Design Guide to your project, include
				the snippets below in your project.
			</p>
			<section>
		...
		<section>
			...
			<p>
				Our script runs{" "}
				<CodeTags type="secondary" code="dg.script.initAll();" /> on
				DOMContentLoaded making it so you have to run{" "}
				<CodeTags type="secondary" code="dg.<component_name>.init();" />{" "}
			...
			<p>
				...
				one object. If several components are initialized it will return an
				array of objects.
			</p>
		...
		<section>
			...
			<p>
				The design guide is tested and currently supported by these browsers.
			</p>
			...
			<p>
				...
				browsers than the ones supported by the Design Guide you need to
				maintain and test the component code in in your project.{" "}
			</p>
		</section>
	</section>
);
