    ...
    <section>
        ...
        <div className="slab slab-plain py-5 px-0">
            <div className="col-12 col-sm-6 m-auto">
                ...
                <div className="slab slab-funny flat slab-edges d-flex justify-content-center mb-0 py-1 extra-small">24px</div>
                <InputGroup id="guideline-select-example" type="select" label="Label" placeholder="Select an option" selectOptions={["Option 1", "Option 2"]} className="mb-0"/>
                <div className="slab slab-funny flat slab-edges d-flex justify-content-center mb-0 py-1 extra-small">24px</div>
