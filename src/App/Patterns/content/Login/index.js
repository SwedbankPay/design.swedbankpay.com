...
const Overview = () => (
    <section>
        ...
        <img src={`${basename}img/documentation/patterns/login-pattern-example.png`} className="d-none d-md-block w-100 border-left border-right border-bottom" alt="A login screen with the login functionality to the left and an image to the right showing a woman using a laptop." />
...
const ContentGuidelines = () => (
    <section>
        ...
        <section>
            <h3>Image</h3>
            <img src={`${basename}img/documentation/patterns/login-img-collection-example.png`} alt="Selection of images showing people in different settings using digital devices." className="w-100 mb-3" />
        ...
        <section>
            ...
            <EditableComponentPreview language="html" codeFigure showCasePanel staticPreview>
                <div className="col-sm-6 col-12 m-auto px-0 pt-3">
                    <InputGroup type="email" id="login-client-side" validationState="error" label="Email" autoComplete="email" errorMessage="Email is required" />
                </div>
            </EditableComponentPreview>
        </section>
        <section>
