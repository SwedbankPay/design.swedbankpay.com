...
const LoginForm = ({
	...
	return (
		<>
			{productLabel && (
				<span className="extra-small text-secondary-light-1">
					{productLabel}
				</span>
			)}
			{"\n"}
			...
			{additionalText && (
				<p className="small mt-3">
					{helpDesk && (
						<>
							<LinkComponent linkText="Contact helpDesk" /> if you are having
							trouble signing in.
						</>
					)}
					{additionalText}
			...
			{logo && (
				<Logotype
					type="vertical d-none d-sm-block mx-auto mt-5"
