...
describe("Component: Button -", () => {
    ...
    describe("Anchor tag:", () => {
        it("renders a button inside an anchor tag when prop href is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" href="test" />);
        ...
        it("renders a button inside an anchor tag with label when prop href and label is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" href="test" label="test" />);
        ...
        it("renders a button with specified size inside an anchor tag when prop href and size is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" href="test" size="size-test" />);
        ...
        it("renders a loading button inside an anchor tag when prop href and loading is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" href="test" loading />);
        ...
        it("renders a full width button inside an anchor tag when prop href and fullWidth is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" href="test" fullWidth />);
        ...
        it("renders a button inside an anchor tag with class active when prop href and active is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" href="test" active />);
        ...
        it("renders a button inside an anchor tag with id when prop href and id is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" href="test" id="test" />);
        ...
        it("renders a button inside an anchor tag with name when prop href and name is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" href="test" name="test" />);
        ...
        it.skip("renders a disabled button inside an anchor tag when prop href and disabled is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" href="test" disabled />);

            expect(componentForSnap.toJSON()).toMatchSnapshot();
        });

        it("renders a button with icon inside an anchor tag when prop href and icon is provided", () => {
            const { container } = render(<Button type="primary" href="test" icon="test" />);
            ...
            const componentForSnap = renderer.create(<Button type="primary" href="test" icon="test" />);

            expect(componentForSnap.toJSON()).toMatchSnapshot();
        });

        it("renders a button with icon and label inside a span inside an anchor tag when prop href, label and icon is provided", () => {
            const { container } = render(<Button type="primary" href="test" icon="test" label="test" />);

            expect(container.querySelector("i")).toHaveClass("material-icons");
            expect(container.querySelector("i")).toHaveTextContent("test");
            expect(container.querySelector("i")).toHaveAttribute("aria-hidden", "true");
            expect(screen.getByRole("button").querySelector("span")).toHaveTextContent("test");

            const componentForSnap = renderer.create(<Button type="primary" href="test" icon="test" label="test" />);
    ...
    describe("Input tag:", () => {
        ...
        it("renders a button with specified size inside an input tag when prop input and size is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" input size="size-test" />);
        ...
        it("renders a loading button inside an input tag when prop input and loading is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" input loading />);
        ...
        it("renders a full width button inside an input tag when prop input and fullWidth is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" input fullWidth />);
        ...
        it.skip("renders a button with class active inside an input tag when prop input and active is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" input active />);
        ...
        it("renders a button with the specified type inside an input tag when prop input and btnType is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" input btnType="test" />);
        ...
        it("renders a button with the specified id inside an input tag when prop input and id is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" input id="test" />);
        ...
        it("renders a button with the specified name inside an input tag when prop input and name is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" input name="test" />);
        ...
        it("renders a disabled button inside an input tag when prop input and disabled is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" input disabled />);
        ...
        it("renders a button inside an input tag with value attribute when prop input and value is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" input value="test" />);
    ...
    describe("Button tag:", () => {
        ...
        it("renders a button with a label when prop label is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" label="test" />);
        ...
        it("renders a button with specified size when prop size is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" size="size-test" />);
        ...
        it("renders a loading button when prop loading is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" loading />);
        ...
        it("renders a full width button when prop fullWidth is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" fullWidth />);
        ...
        it.skip("renders a button with class active when prop active is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" active />);
        ...
        it("renders a button with the specified type when prop btnType is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" btnType="test" />);
        ...
        it("renders a button with the specified id when prop id is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" id="test" />);
        ...
        it("renders a button with the specified name when prop name is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" name="test" />);
        ...
        it("renders a disabled button when prop disabled is provided", () => {
            ...
            const componentForSnap = renderer.create(<Button type="primary" disabled />);
        ...
        it("renders a button with an icon when prop icon is provided", () => {
            ...
            expect(screen.getByRole("button").querySelector("i")).toHaveClass("material-icons-outlined");
            expect(screen.getByRole("button").querySelector("i")).toHaveTextContent("test");
            expect(screen.getByRole("button").querySelector("i")).toHaveAttribute("aria-hidden", "true");

            const componentForSnap = renderer.create(<Button type="primary" icon="test" />);
        ...
        it("renders a button with icon and label when prop icon and label is provided", () => {
            ...
            expect(screen.getByRole("button").querySelector("i")).toHaveClass("material-icons-outlined");
            expect(screen.getByRole("button").querySelector("i")).toHaveTextContent("icon");
            expect(screen.getByRole("button").querySelector("i")).toHaveAttribute("aria-hidden", "true");
            expect(screen.getByRole("button").querySelector("span")).toHaveTextContent("test");

            const componentForSnap = renderer.create(<Button type="primary" icon="icon" label="test" />);
