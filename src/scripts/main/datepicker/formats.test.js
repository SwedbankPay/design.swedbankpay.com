...
describe("scripts: datepicker - formats", () => {
    ...
    describe("norwegian (nb)", () => {
        ...
        it("has correct shorthand month values", () => {
            expect(testVariables.months.shorthand.every(month => formats.nb.months.shorthand.includes(month))).toBeTruthy();
        });

        it("has correct longhand month values", () => {
            expect(testVariables.months.longhand.every(month => formats.nb.months.longhand.includes(month))).toBeTruthy();
        });

        it("has correct shorthand weekdays values", () => {
            expect(testVariables.months.shorthand.every(weekdays => formats.nb.months.shorthand.includes(weekdays))).toBeTruthy();
        });

        it("has correct longhand weekdays values", () => {
            expect(testVariables.months.longhand.every(weekdays => formats.nb.months.longhand.includes(weekdays))).toBeTruthy();
        });
    ...
    describe("swedish (sv)", () => {
        ...
        it("has correct shorthand month values", () => {
            expect(testVariables.months.shorthand.every(month => formats.sv.months.shorthand.includes(month))).toBeTruthy();
        });

        it("has correct longhand month values", () => {
            expect(testVariables.months.longhand.every(month => formats.sv.months.longhand.includes(month))).toBeTruthy();
        });

        it("has correct shorthand weekdays values", () => {
            expect(testVariables.months.shorthand.every(weekdays => formats.sv.months.shorthand.includes(weekdays))).toBeTruthy();
        });

        it("has correct longhand weekdays values", () => {
            expect(testVariables.months.longhand.every(weekdays => formats.sv.months.longhand.includes(weekdays))).toBeTruthy();
        });
    ...
    describe("danish (da)", () => {
        ...
        it("has correct shorthand month values", () => {
            expect(testVariables.months.shorthand.every(month => formats.da.months.shorthand.includes(month))).toBeTruthy();
        });

        it("has correct longhand month values", () => {
            expect(testVariables.months.longhand.every(month => formats.da.months.longhand.includes(month))).toBeTruthy();
        });

        it("has correct shorthand weekdays values", () => {
            expect(testVariables.months.shorthand.every(weekdays => formats.da.months.shorthand.includes(weekdays))).toBeTruthy();
        });

        it("has correct longhand weekdays values", () => {
            expect(testVariables.months.longhand.every(weekdays => formats.da.months.longhand.includes(weekdays))).toBeTruthy();
        });
    ...
    describe("finnish (fi)", () => {
        ...
        it("has correct shorthand month values", () => {
            expect(testVariables.months.shorthand.every(month => formats.fi.months.shorthand.includes(month))).toBeTruthy();
        });

        it("has correct longhand month values", () => {
            expect(testVariables.months.longhand.every(month => formats.fi.months.longhand.includes(month))).toBeTruthy();
        });

        it("has correct shorthand weekdays values", () => {
            expect(testVariables.months.shorthand.every(weekdays => formats.fi.months.shorthand.includes(weekdays))).toBeTruthy();
        });

        it("has correct longhand weekdays values", () => {
            expect(testVariables.months.longhand.every(weekdays => formats.fi.months.longhand.includes(weekdays))).toBeTruthy();
        });
    ...
    describe("english (en)", () => {
        ...
        it("has correct shorthand month values", () => {
            expect(testVariables.months.shorthand.every(month => formats.en.months.shorthand.includes(month))).toBeTruthy();
        });

        it("has correct longhand month values", () => {
            expect(testVariables.months.longhand.every(month => formats.en.months.longhand.includes(month))).toBeTruthy();
        });

        it("has correct shorthand weekdays values", () => {
            expect(testVariables.months.shorthand.every(weekdays => formats.en.months.shorthand.includes(weekdays))).toBeTruthy();
        });

        it("has correct longhand weekdays values", () => {
            expect(testVariables.months.longhand.every(weekdays => formats.en.months.longhand.includes(weekdays))).toBeTruthy();
        });
    ...
    describe("robotic (iso8601)", () => {
        ...
        it("has correct shorthand month values", () => {
            expect(testVariables.months.shorthand.every(month => formats.iso8601.months.shorthand.includes(month))).toBeTruthy();
        });

        it("has correct longhand month values", () => {
            expect(testVariables.months.longhand.every(month => formats.iso8601.months.longhand.includes(month))).toBeTruthy();
        });

        it("has correct shorthand weekdays values", () => {
            expect(testVariables.months.shorthand.every(weekdays => formats.iso8601.months.shorthand.includes(weekdays))).toBeTruthy();
        });

        it("has correct longhand weekdays values", () => {
            expect(testVariables.months.longhand.every(weekdays => formats.iso8601.months.longhand.includes(weekdays))).toBeTruthy();
        });
