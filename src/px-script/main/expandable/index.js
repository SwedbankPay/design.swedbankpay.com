class Accordion {
    constructor (element) {
        ...
        if (!this.expandables) {
            console.warn("accordion.init(): No expandable  found")
        }
        ...
        this.expandables.forEach(exp => {
            ...
            if (!expHeader) {
                console.warn("accordion.init(): No expandable-header found");
...
class Expandable {
    constructor (element) {
        ...
        this.expHeader
            ...
            : console.warn("expandable.init: No expandable-header found");
    }
}
