...
# The purpose of this file is to find out what branch we merged.
# Then we pass the branch name as an output so that our janitor can delete that branch folder from azure. [THN]
